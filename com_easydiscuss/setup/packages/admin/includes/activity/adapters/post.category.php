...
class EasyDiscussActivityPostCategory extends EasyDiscussActivityAbstract
{
	...
	public function translate($data)
	{
		...
		$text = JText::sprintf('COM_ED_ACTIVITY_POST_CATEGORY', $this->getActorName($actor, true, $data->uid), $this->getCategoryTitle($oldCategory), $this->getCategoryTitle($newCategory), $timeLapsed);
		return $text;
	}
}
